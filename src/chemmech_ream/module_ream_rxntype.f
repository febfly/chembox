...
!                  REAM chemical mechnism input file 
!               2. symbol used in the REAM chemical mechnism input file
!                  to denote the special reaction type
!               3. comment of the reaction type
!               4. the reaction type that appears prior to this reaction
!                  type in the REAM chemical mechnism input file; 0
      ...
      do ir = 1, nrxn
         ...
         select case (itp)
           ...
           case (2)
                ...
                rate_const=kh*p(7)**fexp/(1d0+xyrat)
           !B
           case (3)
                k1=r1(p(1:3),Temp)
